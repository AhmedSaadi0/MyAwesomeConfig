local words_dict = {
    ...
    "التجربة ! وانهض فوراً مستبشراً ، فتلك هي أولى درجات النجاح.",
    "الحديث في الهاتف: عندما يرن الهاتف ابتسم وأنت تتلقى السماعة، فإن محدثك على الطرف الآخر سيرى ابتسامتك من خلال نبرات صوتك.",
    "الزواج: تزوج من تجيد المحادثة، فعندما يتقدم بك العمر ستعرف أهمية ذلك، عندما يصبح الحديث مع من تحب قمة أولوياتك واهتماماتك.",
    "الحب: إذا أحببت شخصاً فاذهب إليه وقل إنك تحبه ، إلّا إذا كنت لا تعني ما تقول فعلاً ! لأنه سيعرف الحقيقة بمجرد النظر في عينيك.",
    "الاعتذار: لا تتردد في أن تتأسف لمن أخطأت في حقه ، وانظر لعينيه وأنت تنطق بكلمات الاعتذار ، ليقرأها في عينيك وهو يسمعها بأذنيه.",
    "المعاملة: لا تحكم على شخص من أقربائه فقط ، فالإنسان لم يختر والديه ، فما بالك بأقربائه.",
    "الحديث: عندما لا تريد الإجابة على سؤال ، فابتسم للسائل قائلاً: هل تعتقد أنه فعلاً من المهم.",
    "الصداقة: لا تدع الأشياء الصغيرة تدمر صداقتك الغالية مع الآخرين ، فالصداقة الحقيقية تاج على رؤوس البشر ، لا يدركه إلا سكان الجدران الخالية والقلوب الخاوية.",
    "الحياة: لا تسخر من الآخرين وأحلامهم الوردية الجميلة ، خاصة من تعتقد أنهم أقل منك من البسطاء الطيبين ، فلربما تكون منزلة خادمك عند الله أسمى وأرفع منك ومن كثير من علياء القوم ، وقد تحظى بشفاعتهم يوم القيامة، ولا تقلل من شأن الأحلام ، فالدنيا بدونها رحلة جافة ومملة مهما يكن الواقع جميلا.",
    "الحوار: فكر كثيراً ، واستنتج طويلا ، وتحدث قليلاً، ولا تهمل كل ما تسمعه ! فمن المؤكد أنك ستحتاجه في المستقبل.",
