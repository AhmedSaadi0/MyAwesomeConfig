...
local locker_config = {
	...
	bg_dir = config.module.lockscreen.bg_dir or (config_dir .. 'themes/wallpapers/'),
	-- Default background
...
local clock_format = '<span font="JF Flat 52">%H:%M</span>'
if not locker_config.military_clock then
	clock_format = '<span font="JF Flat 52">%I:%M %p</span>'
end
...
local msg_table = {
	...
	'بطل بعسسة!',
	'مابش معك كلمة السر. هههههههههههه.',
	'بخخخخخخخخخخخخخخخخخ.',
	'سيتم تفجير الجهاز خلال 5 ثواني!',
	'احسن لك ابوها.'
}

local wanted_msg = wibox.widget {
	markup = 'سيتم الإبلاغ عن هذا الحدث!',
	font   = 'JF Flat 10',
	align  = 'center',
	valign = 'center',
	widget = wibox.widget.textbox
