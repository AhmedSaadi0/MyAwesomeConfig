...
theme.bg_normal = "#1d0838"
theme.widget_bg = "#120524"
theme.bg_focus = "#120524"
...
theme.wallpaper = "~/.config/awesome/themes/wallpapers/win20.png"
...
theme.icons = require("themes.icons-win20")
